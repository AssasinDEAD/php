...
<body>
   ...
   <div class="super_container">
      ...
      <?php require_once "assets/navAdmin.php"; ?>
                  ...
                  <div class="card" >
                     ...
                     <div class="price_box d-flex flex-row align-items-center">
                        ...
                        <?php if($post['user_id'] == $user['id'] or $user['role'] == 'admin' ): ?>
                                             <a class="btn btn-info me-2" href="editPg.php?post_id=<?= $post['id'] ?>">Edit →</a>
                                             <form onsubmit="return confirm('Really want to delete?')" action="deletePost.php" method="post">
                                                <input type="hidden" name="post_id" value="<?= $post['id']?>">
                                                <button class="btn btn-danger" type="submit">Delete</button>
                                             </form>
                                             <form onsubmit="return confirm('Really want to post?')" action="publicPost.php" method="post">
                                                <input type="hidden" name="post_id" value="<?= $post['id']?>">
                                                <button class="btn btn-danger" type="submit">public</button>
                                             </form>
                                             <?php endif; ?>
                                             </div>
                                          </div>
