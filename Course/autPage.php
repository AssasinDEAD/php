<?php
	session_start();
      ...
      $user = $_SESSION['user'] ?? ''; 
      require_once 'assets/checkModer.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
   ...
   <div class="super_container">
      ...
      <?php require_once "assets/navAut.php"; ?>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 hero_box_col">
                     <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                        <img src="images/earth-globe.svg" class="svg" alt="">
                        <div class="hero_box_content">
                           <h2 class="hero_box_title">Add authors</h2>
                           <a href="addAuthForm.php" class="hero_box_link">view more</a>
                        </div>
                     </div>
                  </div>
